...
1. **Availability probe.** Run:
   ...
   `docs/plans/<id>/reviews/external-reviewer-codex.md` and exit 0.
...
SKIP — <one-line reason: "codex not installed" | "codex timed out after 300s" | "codex returned non-zero with no output">
