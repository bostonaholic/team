...
so it installs as a native Antigravity plugin — all 81 skills and all 13 agents.
...
- **81 entry-point + methodology skills** in `skills/`: slash commands, the standalone `/shipit`, `/pr-open-comments`, `/pr-watch-as-author`, `/pr-watch-as-reviewer`, `/groom-backlog`, `/pr-cleanup`, `/pr-verify`, `/pr-rebase`, `/reflect`, `/why`, and `/how` utilities, and shared methodologies
