...
- **50 entry-point + methodology skills** in `skills/` — slash commands, the standalone `/shipit`, `/pr-open-comments`, `/pr-watch`, and `/groom-backlog` utilities, and shared methodologies
