...
- **14 agents** in `agents/` — decoupled workers that read predecessor artifacts from `docs/plans/` and write their outputs there
...
- **1 registry** at `skills/team/registry.json` — phase-tagged inventory of the 14 agents
