...
- `/team-pr` got about a quarter smaller without losing a rule. The duplicated PR body template, restated changelog and commit rules, worked examples, and history notes are gone. Every gate, stop, and PR-safety rule it had still applies. **What this asks of you:** nothing.
