...
Read only `docs/plans/2026-09-08-neutral-label/2-questions.md` and the neutral
repository files needed to answer it. Do not inspect sibling plan artifacts.
