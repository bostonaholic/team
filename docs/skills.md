...
The catalog has 27 registered skills: 25 commands and 2 methodologies. Shared principles, playbooks, templates, and operational rules are ordinary [installed resources](migration-contract.md).
