...
The catalog has 32 registered skills: 25 commands and 7 methodologies. Shared principles, playbooks, templates, and operational rules are ordinary [installed resources](migration-contract.md).
