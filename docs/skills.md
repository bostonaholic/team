...
The catalog has 55 registered skills: 25 commands and 30 methodologies. Shared principles, playbooks, templates, and operational rules are ordinary [installed resources](migration-contract.md).
