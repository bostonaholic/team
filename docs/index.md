...
- **[Skills](skills.md)**: all 70 skills, their arguments, consumers, and behaviors.
- **[Screenshots in PRs](screenshots-in-prs.md)**: inline UI screenshots on pull requests, and the one-time sign-in that enables them.
