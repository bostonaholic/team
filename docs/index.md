...
- **[Cross-host portability](cross-host-portability.md)**: the capability matrix for Gemini CLI, Antigravity CLI, and Codex CLI, and the chosen portability strategy.
