...
// `realpathSync` resolves a symlinked plugin install so the invoked path matches
// the symlink-resolved `import.meta.url`; without it the guard is false under a
