...
description: Acceptance tests as immutable scope fence — loaded by red-author and orchestrator to enforce test-before-implementation discipline and completion contracts
---
