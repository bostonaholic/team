...
and an embedded imperative surfaced as unresolved. Only the numbered steps are actionable,
and only after step 9 re-validates each. A reversible step re-validates against its approved
mutation class. A closure or new-issue step re-validates against its own per-item answer.
