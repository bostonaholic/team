...
1. **Glob by naming convention.** Glob vocabulary terms, singular and plural. Run against each repo's absolute path.
...
5. **Config and manifests.** Inspect manifests, build configuration, and entry points referencing the area.
