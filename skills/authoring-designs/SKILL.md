...
Read `1-task.md` and `5-research.md`. Read any referenced `3-prd.md` first and apply
the downstream contract in `skills/product-requirements-doc/SKILL.md`; its
scope and acceptance criteria bind the design. Read `4-repos.md` when present.
