...
- **How It Works** — what triggers it, each step, where data goes, the
  decision points. Prose, not pseudocode, citing files and functions. Add
  a mermaid diagram when the flow crosses several components and a
  diagram clarifies; skip it when prose covers the flow.
