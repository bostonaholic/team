---
name: how
description: 'Explains subsystem architecture and runtime flow. Trigger on "how does X work", "explain the architecture", or "/how".'
effort: medium
...
Call the Skill tool with `principle-generator-evaluator` and
