...
// Phase modules and standalone entries with multi-step procedures.
...
describe("Slice 2: phase modules and entry skills load principle-progress-tracking", () => {
...
// ---------------------------------------------------------------------------
// The design-review methodology and its entry point each load the convention
// before their own multi-step work.
// ---------------------------------------------------------------------------
