...
const SKILL_BUDGET_REASONS: Record<string, BudgetReason> = Object.fromEntries(
  [
    ...
    ["pr-cleanup", 613],
    ["pr-open-comments", 469],
    ["pr-rebase", 735],
    ["pr-verify", 183],
    ["pr-watch-as-author", 315],
    ["pr-watch-as-reviewer", 1084],
    ...
    ["test-driven-bug-fix", 148],
    ["test-first-development", 134],
    ["test-style", 266],
    ["tracking-tickets", 82],
    ["verifying-ux", 155],
    ["why", 204],
