...
export const E2E_TOUCHFILES: Record<string, string[]> = {
  ...
  // The code standards own the comment rule content, so a change to it
  ...
  "eng-design-doc-review-planted-unsupported-guarantee": [
    ...
    "skills/eng-design-doc-review/**",
    "tests/eng-design-doc-review.evals.ts",
    "evals/fixtures/eng-design-doc-review/planted-unsupported-guarantee/**",
    "evals/rubrics/eng-design-doc-review.md",
  ],
  ...
  "unslop-neutral-research": [
    ...
    "skills/team/references/writing.md",    "tests/helpers/unslop-core.ts",
...
export const E2E_TIERS: Record<string, "gate" | "periodic"> = {
  ...
  "eng-design-doc-review-planted-unsupported-guarantee": "periodic",
